...
func GetareaofinterestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/areaOfInterest", cfg.BaseURL)
		...
		var result models.AreaOfInterestResult
...
func CreateGetareaofinterestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_areaOfInterest",
		mcp.WithDescription("This operation returns a bounding box around the most important area of the image.
...
Upon failure, the error code and an error message are returned. The error code could be one of InvalidImageUrl, InvalidImageFormat, InvalidImageSize, NotSupportedImage, FailedToProcess, Timeout, or InternalServerError."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetareaofinterestHandler(cfg),
	}
}
