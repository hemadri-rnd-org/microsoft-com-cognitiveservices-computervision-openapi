# Computer Vision Client MCP Server

This MCP (Model Content Protocol) server provides access to Computer Vision Client API functionality through HTTP, HTTPS, and STDIO transport modes.
